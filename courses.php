  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php"><span>E-Learning Website</span></a>
      </div>
...
<!--                  password-->
                ...
                <p class="login-box-msg">Total Amount   ₹199</p>            
                <div class="form-group has-feedback">
                  <!----- credit card number -------------->
      
                  <input class="form-control" placeholder="Credit card number < 6" id="loginpsw" type="password" autocomplete="off" name="cred" min-length=6/>
                  <span style="display:none;font-weight:bold; position:absolute;color: grey;position: absolute;padding:4px;font-size: 11px;background-color:rgba(128, 128, 128, 0.26);z-index: 17;  right: 27px; top: 5px;" id="span_loginpsw"></span>
